...
{
    Task<(IReadOnlyList<Endereco> Items, int Total)> ListarAsync(int usuarioId, string? termo, string? ordenarPor, string? uf, string? cidade, int pagina, int tamanhoPagina, CancellationToken ct = default);
